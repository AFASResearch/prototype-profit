...
// RPT00692 — Mock endpoint: Abonnement boekingslayout (na einddatum voorbeeld)
app.MapGet("/api/rpt00692-abonnement-boeking", () => new {
    Id = "1",
    abonnement = "4244",
    debiteur = "Facilicom BV (10234)",
    omschrijving = "EnYol Net Onderhoud",
    cyclusFacturering = "Maand (M1)",
    factuurmoment = "4",  // Aantal dagen ná einddatumcyclus
    cyclusverlenging = "",
    begindatumFactuurcyclus = "2026-04-01T00:00:00Z",
    datumVerlenging = (string?)null,
    aantalDagen = 10,
    methodeVerdeling = "Pro-rata (P)"
});
app.MapPatch("/api/rpt00692-abonnement-boeking", () => Results.Ok());

app.MapGet("/api/rpt00692-abonnement-boeking/regels", () => new[] {
    new { code = "7002", omschrijving = "EnYol Net Onderhoud", aantal = 1, begin = "2025-02-24T00:00:00Z", orgPrijs = 69.98m, afwPrijs = 0m, kortingPerc = 0m, korting = 0m },
    new { code = "7005", omschrijving = "Installatie Onderhoud", aantal = 1, begin = "2026-01-01T00:00:00Z", orgPrijs = 149.50m, afwPrijs = 0m, kortingPerc = 0m, korting = 0m },
    new { code = "7010", omschrijving = "Software Licentie", aantal = 2, begin = "2026-03-15T00:00:00Z", orgPrijs = 29.95m, afwPrijs = 25.00m, kortingPerc = 0m, korting = 0m },
});
...
app.MapGet("/api/rpt00692-artikelgroep", () => new {
    Id = "1",
    rekEmballage = "4100 - Emballage",
    rekVerwijderingsbijdrage = "4200 - Verwijderingsbijdrage",
    transitorischeBoeking = false,
    ...
    startperiodeBoekjaar = 2026,
    startperiodePeriode = 7
});

app.MapPatch("/api/rpt00692-artikelgroep", () => Results.Ok());
...
app.MapGet("/api/rpt00692-genereer-wizard/preview", () => new[] {
    new { abonnementsregel = "AR-0010", abonnement = "AB-1001 Facilicom BV", omschrijving = "Schoonmaak kantoor april", bedrag = 3750.00m },
    new { abonnementsregel = "AR-0011", abonnement = "AB-1001 Facilicom BV", omschrijving = "Beveiliging april", bedrag = 6000.00m },
    new { abonnementsregel = "AR-0012", abonnement = "AB-1002 Bakker BV", omschrijving = "Catering april", bedrag = 89.25m },
    new { abonnementsregel = "AR-0013", abonnement = "AB-1003 Groen & Co", omschrijving = "Onderhoud tuin april", bedrag = 525.00m },
});
...
// RPT00692 — Saldoverklaring wizard (stap 1: selectie)
app.MapGet("/api/rpt00692-saldoverklaring-wizard", () => new {
    Id = "1",
    Administratie = "1",
    Boekjaar = 2026,
    PeriodeVan = "1",
...
// RPT00692 — Mock endpoint: Abonnement met KPI (US08)
app.MapGet("/api/rpt00692-abonnement-kpi", () => new {
    Id = "1",
    abonnement = "AB-1001",
    debiteur = "Facilicom BV",
    artikelgroep = "Schoonmaak",
    facturatiemethode = "Achteraf",
    begindatum = "01-01-2026",
    einddatum = "31-12-2026",
    cyclus = "M1 – Maandelijks",
    begindatumCyclus = "01-04-2026",
    einddatumCyclus = "30-04-2026",
    aantalDagenAchteraf = 15
});

// RPT00692 — Mock endpoint: KPI-waarden voor dataVisualizations (US08)
app.MapGet("/api/rpt00692-abonnement-kpi-values", () => new[] { new {
    dagenTotFacturering = 32
} });
