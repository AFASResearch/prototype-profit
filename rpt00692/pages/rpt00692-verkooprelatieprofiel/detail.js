export default function (services) {
    ...
    const nietMidden = createExpression([mainModel.properties.factuurmoment], v => v != null && v !== '' && v !== '5');
                ...
                // --- Factureren ---
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            ...
                            fields: [
                                { labelText: constant('Factuurmoment'), property: mainModel.properties.factuurmoment, getMicroCopyText() { return 'Standaard factuurmoment voor nieuwe abonnementen van debiteuren met dit profiel. Laat leeg om de omgevingsinstelling te gebruiken.'; } },
                                { labelText: constant('Aantal dagen'), property: mainModel.properties.aantalDagen, getMicroCopyText() { return 'Standaard aantal dagen verschuiving voor nieuwe abonnementen van debiteuren met dit profiel.'; } },
                            ]
                        },
                    ]
                },
