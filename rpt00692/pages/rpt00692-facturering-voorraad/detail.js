export default function (services) {
    let { data: { dataType, createModel, createProperty, constant, createExpression }, rest } = services;
                ...
                // --- Abonnementen ---
                {
                    ...
                    elements: [
                        ...
                        },
                        {
                            ...
                            fields: [
                                { labelText: constant('Factuurmoment'), property: mainModel.properties.factuurmoment, getMicroCopyText() { return 'Systeemstandaard factuurmoment voor nieuwe abonnementen. Geldt als het verkooprelatieprofiel geen afwijkende waarde heeft.'; } },
                                { labelText: constant('Aantal dagen'), property: mainModel.properties.aantalDagen, getMicroCopyText() { return 'Systeemstandaard aantal dagen verschuiving voor nieuwe abonnementen.'; } },
                            ]
                        },
                        {
                            type: 'fieldGroup',
                            ...
                            fields: [
                                { labelText: constant('Periodetoekenning toepassen'), property: mainModel.properties.periodetoekenningToepassen, getMicroCopyText() { return 'Rekent verwachte abonnementsomzet toe aan een periode vóór de periodeafsluiting, ook als de factuur er nog niet is.'; } },
                                { labelText: constant('Te factureren abonnementen omzet'), property: mainModel.properties.teFacturerenOmzetRekening, getMicroCopyText() { return 'Grootboekrekening die tegengeboekt wordt bij het factureren.'; } },
                            ]
                        }
                    ]
                },
