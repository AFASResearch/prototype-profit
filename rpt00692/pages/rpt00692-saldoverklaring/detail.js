export default function (services) {
    let { data: { dataType, createModel, createProperty, constant, createBig }, rest } = services;
    ...
    return {
        ...
        async initialize(context) {
            let response = await rest.executeGetQuery({ url: '/api/rpt00692-saldoverklaring/init' });
