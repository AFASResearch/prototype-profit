...
export default function (services: BlueprintFactories): DetailPage {
  ...
  let mainModel = createModel({
    properties: {
      ...
      MethodeAfmelding: createProperty(dataType.text()),
    }
  });


  return {
    id: 'rpt00751-integratie-financieel',
    type: 'detail',
          ...
          elements: [
            {
              ...
              fields: [
                ...
                { labelText: constant('Dekking inhuur derden splitsen'), property: mainModel.properties.DekkingInhuurDerdenSplitsen },
      ...
      main: {
        ...
        hooks: {
          initializer: rest.getQueryModelHook(mainModel, {
            url: '/api/rpt00751-integratie-financieel',
