          ...
          elements: [
            ...
            },
            {
              ...
              fields: [
                ...
                { labelText: constant('Rek. dekking kp inkopen'), property: mainModel.properties.RekDekkingKpInkopen,
          ...
          elements: [
            {
              ...
              fields: [
                ...
                { labelText: constant('Rek. dekking kp inkopen IC'), property: mainModel.properties.RekDekkingKpInkopenIC,
      ...
      main: {
        ...
        hooks: {
          initializer: rest.getQueryModelHook(mainModel, {
            url: '/api/rpt00751-integratiegroep',
