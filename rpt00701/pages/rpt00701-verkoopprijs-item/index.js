                        ...
                        actions: [
                            {
                                ...
                                async execute(context) {
                                    let result = await context.startDialog({ routePattern: 'rpt00701-nieuwe-verkoopprijs/:id', routeParameters: { id: '1' } }, {}, { editMode: 'Edit' });
                                    return !!result;
                                }
                            },
                            {
                                ...
                                async execute(context) {
                                    ...
                                    if (!selected)
                                        return false;
                                    let result = await context.startDialog({ routePattern: 'rpt00701-nieuwe-verkoopprijs/:id', routeParameters: { id: selected.id } }, {}, { editMode: 'Edit' });
                                    return !!result;
                                }
                            },
                        ],
