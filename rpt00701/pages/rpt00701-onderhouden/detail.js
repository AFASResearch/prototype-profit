                    ...
                    elements: [
                        // === REGELS ===
                        {
                            ...
                            actions: [
                                {
                                    ...
                                    async execute(context) {
                                        let result = await context.startDialog({ routePattern: 'rpt00701-nieuw-abonnementstarief/:id', routeParameters: { id: '1' } }, {}, { editMode: 'Edit' });
                                        return !!result;
                                    },
                            ...
                            inlineEdit: {
                                ...
                                async updater(_context, filter, value, columnKey) {
                                    return true;
                                },
                                getItemFields(_item) {
                                    return [
