export default function (services) {
    ...
    mainModel.properties.AantalDagen.config.active = createExpression([mainModel.properties.Factuurmoment], (v) => v !== '5');
                    ...
                    elements: [
                        ...
                        },
                        {
                            ...
                            inlineEdit: {
                                ...
                                async updater(context, filter, value, columnKey) {
